        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              Phishing Email <span className="text-gradient">Showcase</span>
            </h1>
            <p className="text-xl text-muted-foreground animate-fade-in" style={{ animationDelay: "0.2s" }}>
              Learn to identify and protect yourself from phishing attacks. This guide breaks down common tactics used by attackers and how to stay safe.
            </p>
          </div>
        </div>
      </section>
