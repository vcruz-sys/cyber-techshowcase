          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-card rounded-2xl p-8 md:p-12 border border-border shadow-elevated">
              <div className="prose prose-invert max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">I'm Victor Cruz an aspiring Cybersecurity Analyst, hands-on problem solver, and the Technical Analyst for my project group, Erudition Tech. I'm currently part of I.C. Stars Cycle 19, where every day pushes me to grow as both a leader and a technologist. Victor Cruz an aspiring Cybersecurity Analyst, hands-on problem solver, and the Technical Analyst for my project group, Erudition Tech. I'm currently part of I.C. Stars Cycle 19, where every day pushes me to grow as both a leader and a technologist.<span className="text-foreground font-semibold">Victor Cruz</span>—an aspiring Cybersecurity Analyst, hands-on problem solver, and the Technical Analyst for my project group, <span className="text-primary">Erudition Tech</span>. I'm currently part of I.C. Stars Cycle 19, where every day pushes me to grow as both a leader and a technologist.
                </p>
