...
const PowerBIShowcase = () => {
  ...
  const insights = [
    ...
    "Reduced report generation time through automated data refresh",
    "Enabled stakeholders to self-serve insights through interactive dashboards",
    "Identified key trends that informed strategic decisions",
    "Demonstrated proficiency in DAX formulas and measures",
  ];
            ...
            <div className="bg-gradient-card rounded-2xl border border-border p-8 md:p-12 shadow-elevated animate-fade-in">
              <div className="prose prose-invert max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  This Power BI project demonstrates my capability to work with data end-to-end—from connecting to data sources and transforming raw information, to building interactive dashboards that tell a clear story.
                </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className="p-6 rounded-xl bg-gradient-card border border-border hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 animate-fade-in"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {processSteps.map((step, index) => (
                <div
                  key={step.step}
                  className="flex gap-6 items-start bg-gradient-card rounded-xl border border-border p-6 animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
